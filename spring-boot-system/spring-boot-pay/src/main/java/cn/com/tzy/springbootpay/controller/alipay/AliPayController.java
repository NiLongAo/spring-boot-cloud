...
import cn.com.tzy.springbootpay.entity.AliPayBean;
import cn.com.tzy.springbootpay.utils.StringUtils;
import cn.com.tzy.springbootpay.vo.AjaxResult;
import cn.com.tzy.springbootstarterpayalipay.AliPayApi;
...
//    private final static String RETURN_URL = "/aliPay/return_url";
	...
	public AliPayApiConfig getApiConfig() throws AlipayApiException {
		...
		try {
			aliPayApiConfig = AliPayApiConfigKit.getAliPayApiConfig(aliPayBean.getAppId());
		} catch (Exception e) {
	...
	public AliPayApiConfig test() {
		AliPayApiConfig aliPayApiConfig = AliPayApiConfigKit.getAliPayModel();
