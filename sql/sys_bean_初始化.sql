...
,('monitor','monitor.naocs',4,'服务注册中心','/monitor/naocs','https://www.nilongao.cn/nacos/','grommet-icons:test',1,0,1,'monitore.naocs:list','grommet-icons:test',null)
,('monitor','monitor.minio',4,'资源文件','/monitor/minio','https://www.nilongao.cn/minio','grommet-icons:test',1,0,2,'monitore.minio:list','grommet-icons:test',null)
...
,('monitor','monitor.elasticsearch',4,'elasticsearch可视化','http://1.82.217.118:10012/','http://1.82.217.118:10012/','grommet-icons:test',1,0,6,'monitore.elasticsearch:list','grommet-icons:test',null)
,('monitor','monitor.swagger',4,'Swagger接口文档','/monitor/swagger','http://122.51.147.244:9100/doc.html','grommet-icons:test',1,0,7,'monitore.swagger:list','grommet-icons:test',null)
...
,('monitor','monitor.xxl-job',4,'XXL-JOB分布式定时器','/monitor/xxl-job','https://www.nilongao.cn/xxl-job-admin/','grommet-icons:test',1,0,10,'monitore.xxl-job:list','grommet-icons:test',null)
,('monitor','monitor.certd',4,'自动化SSL证书','/monitor/certd','https://www.nilongao.cn:7001/','grommet-icons:test',1,0,11,'monitore.certd:list','grommet-icons:test',null)
,('monitor','monitor.one-api',4,'API语言大模型','/monitor/oneApi','https://www.nilongao.cn:7011/','grommet-icons:test',1,0,12,'monitore.one-api:list','grommet-icons:test',null)
,('monitor','monitor.v2raya',4,'代理服务','/monitor/v2raya','https://www.nilongao.cn:7891/','grommet-icons:test',1,0,13,'monitore.v2raya:list','grommet-icons:test',null)
-- 视频管理
