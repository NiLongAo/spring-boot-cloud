...
,('monitor','monitor.sentinel',5,'熔断限流配置','http://1.82.217.118:8850/','http://1.82.217.118:8850/','grommet-icons:test',1,0,3,'monitore.sentinel:list','grommet-icons:test',null,null)
,('monitor','monitor.skywalking',5,'链路追踪','http://1.82.217.118:12013/','http://1.82.217.118:12013/','grommet-icons:test',1,0,4,'monitore.skywalking:list','grommet-icons:test',null,null)
...
,('monitor','monitor.elasticsearch',4,'elasticsearch可视化','http://1.82.217.118:10012/','http://1.82.217.118:10012/','grommet-icons:test',1,0,6,'monitore.elasticsearch:list','grommet-icons:test',null,null)
,('monitor','monitor.swagger',4,'Swagger接口文档','/monitor/swagger','http://122.51.147.244:9100/doc.html','grommet-icons:test',1,0,7,'monitore.swagger:list','grommet-icons:test',null,null)
,('monitor','monitor.rabbitmq',5,'RabbitMq消息队列','/monitor/rabbitmq','https://www.nilongao.cn/rabbitmq/','grommet-icons:test',1,0,8,'monitore.rabbitmq:list','grommet-icons:test',null,null)
,('monitor','monitor.seata',5,'Seata分布式事务','http://1.82.217.118:8092/','http://1.82.217.118:8092/','grommet-icons:test',1,0,9,'monitore.seata:list','grommet-icons:test',null,null)
...
,('system','system.sms',2,'短信管理','/system/sms','','icon-park-outline:doc-search-two',1,0,10,null,'icon-park-outline:doc-search-two',null,null)
