...
CREATE TABLE video_device (
    ...
    heart_beat_interval                 int unsigned default 30 COMMENT '心跳间隔 (最低25秒)',
    heart_beat_count                    int unsigned default 2 COMMENT '心跳间隔 (最低2次)',
    position_capability                 int unsigned default 0 COMMENT '定位功能支持情况。取值:0-不支持;1-支持 GPS定位;2-支持北斗定位(可选,默认取值为0',
