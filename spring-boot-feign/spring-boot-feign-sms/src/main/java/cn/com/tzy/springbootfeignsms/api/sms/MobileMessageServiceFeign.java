...
@FeignClient(value = "sms-server",contextId = "sms-server",path = "/api/sms/mobile_message",configuration = FeignConfiguration.class)
public interface MobileMessageServiceFeign {

    @RequestMapping(value = "/page",method = RequestMethod.POST)
    PageResult page(@Validated @RequestBody MobileMessageParam param);
