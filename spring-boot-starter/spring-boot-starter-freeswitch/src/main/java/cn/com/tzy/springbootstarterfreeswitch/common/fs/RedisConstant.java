...
public class RedisConstant {
    public static final String FS_CALL_INFO = "FS_CALL_INFO:";
    public static final String FS_VDN_PHONE_INFO = "FS_VDN_PHONE_INFO:";
    public static final String FS_COMPANY_INFO = "FS_COMPANY_INFO:";
