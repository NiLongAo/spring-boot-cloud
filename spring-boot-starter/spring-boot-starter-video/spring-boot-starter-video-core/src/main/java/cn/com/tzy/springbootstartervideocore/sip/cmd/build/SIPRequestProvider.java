...
public class SIPRequestProvider {
    ...
    public static AuthorizationHeader  createProxyAuthenticateHeader(String request,SipFactory sipFactory,String deviceGbId,String serverGbId,String host,String password,WWWAuthenticateHeader www){
