package cn.com.tzy.springbootstartervideocore.sip;

import cn.com.tzy.springbootstartervideobasic.vo.sip.Address;
import cn.com.tzy.springbootstartervideocore.pool.sip.GbStringMsgParserFactory;
...
import cn.com.tzy.springbootstartervideocore.sip.listener.SipListenerImpl;
...
import cn.com.tzy.springbootstartervideocore.sip.properties.DefaultSipProperties;
...
public class SipServer {
    ...
    private void addListeningPoint(String gbId,String monitorIp, int port){
        ...
        //注册成功后加入缓存备用
        RedisService.getRegisterServerManager().putSip(gbId, Address.builder().gbId(gbId).ip(monitorIp).port(port).build());
    }
