...
public class MediaClient {
    ...
    public static void zlmConfigAuto(MediaServerVo mediaServerVo, boolean restart){
        ...
        NotNullMap map = new NotNullMap() {{
            ...
            putString("hook.on_record_mp4", mediaServerVo.getRecordAssistPort() > 0 ? "" : String.format("%s/%s/%s", finalHookUrl,ZLMediaKitConstant.HOOK_URL_PREFIX,ZLMediaKitConstant.MEDIA_HOOK_ON_RECORD_MP4));
            //事件触发http post超时时间
