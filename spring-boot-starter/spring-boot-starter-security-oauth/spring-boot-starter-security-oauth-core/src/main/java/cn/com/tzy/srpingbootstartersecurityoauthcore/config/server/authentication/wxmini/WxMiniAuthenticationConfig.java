 ...
 * * 自定义验证密码或者验证码
 */
public class WxMiniAuthenticationConfig extends SecurityConfigurerAdapter<DefaultSecurityFilterChain, HttpSecurity> {

    private final WxMaService wxMaService;
    private final BaseUserService userDetailsService;

    public WxMiniAuthenticationConfig(WxMaService wxMaService,BaseUserService baseUserService){
    ...
    public void configure(HttpSecurity http) {
        ...
        // 获取微信小程序登陆提供者
        WxMiniAuthenticationProvider wxMiniAuthenticationProvider = new WxMiniAuthenticationProvider(wxMaService,userDetailsService);
