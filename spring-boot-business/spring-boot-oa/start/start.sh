...
APP_NAME=debug
#skywalking包路径
SKY_LIB='-javaagent:/usr/local/program/spring-cloud/lib/skywalking-agent/skywalking-agent.jar -Dskywalking.agent.service_name=spring-boot-oa -Dskywalking.collector.backend_service=1.82.217.118:12011'
#lib包路径
JAR_LIB='/usr/local/program/spring-cloud/lib/oa-lib'
#jar包路径
JAR_PATH='/usr/local/program/spring-cloud/spring-boot-oa'
#jar名称
JAR_NAME=spring-boot-oa.jar
#日志路径
LOG_PATH=/usr/local/program/spring-cloud/spring-boot-oa/logs
#PID  代表是PID文件
PID=$JAR_NAME\.pid
#JDK路径
JDK_PATH=/usr/local/program/jdk/jdk1.8.0_291/bin/java
#JDK路径
LOG4J2_PATH=file:/usr/local/program/spring-cloud/spring-boot-oa/logback.xml
