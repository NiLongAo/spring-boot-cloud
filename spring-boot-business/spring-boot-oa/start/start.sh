...
APP_NAME=debug
#skywalking包路径
SKY_LIB='-javaagent:/usr/local/program/spring-cloud/lib/skywalking-agent/skywalking-agent.jar -Dskywalking.agent.service_name=spring-boot-oa -Dskywalking.collector.backend_service=1.15.9.228:12011'
#lib包路径
