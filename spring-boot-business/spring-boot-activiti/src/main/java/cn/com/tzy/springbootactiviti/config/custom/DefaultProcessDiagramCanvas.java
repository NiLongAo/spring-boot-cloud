...
public class DefaultProcessDiagramCanvas {
     ...
     */
    public List<GraphicInfo> connectionPerfectionizer(DefaultProcessDiagramCanvas.SHAPE_TYPE sourceShapeType,
     ...
     * @return Shape
     */
    private static Shape createShape(DefaultProcessDiagramCanvas.SHAPE_TYPE shapeType,
                                     GraphicInfo graphicInfo) {
        if (DefaultProcessDiagramCanvas.SHAPE_TYPE.Rectangle.equals(shapeType)) {
            ...
            rhombus.closePath();
            return rhombus;
        } else if (DefaultProcessDiagramCanvas.SHAPE_TYPE.Ellipse.equals(shapeType)) {
            // source is ellipse
