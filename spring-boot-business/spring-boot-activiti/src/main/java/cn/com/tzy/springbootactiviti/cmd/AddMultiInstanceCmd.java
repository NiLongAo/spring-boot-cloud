...
public class AddMultiInstanceCmd implements Command<Void> {
    ...
    public Void execute(CommandContext commandContext) {
        ...
        // 根据表达式获取变量名
        String assigneeValName = ActivitiUtil.getVariableNameByExpression(currentFlowElement.getAssignee());
        newChildExecution.setVariableLocal(assigneeValName, assignee);
