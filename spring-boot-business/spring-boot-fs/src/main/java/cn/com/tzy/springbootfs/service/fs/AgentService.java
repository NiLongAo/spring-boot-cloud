...
public interface AgentService extends IService<Agent>{
    ...
    void callPhone(String typeName, SipServer sipServer, MediaServerVo mediaServerVo, AgentVoInfo agentBySip, String caller, String ssrc,String callBackId, InviteErrorCallback<Object> callback);
