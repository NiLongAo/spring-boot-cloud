...
import cn.com.tzy.springbootapp.service.video.PlatformCatalogService;
...
@RestController("AppVideoPlatformCatalogController")
@RequestMapping(value = "/app/video/platform/catalog")
