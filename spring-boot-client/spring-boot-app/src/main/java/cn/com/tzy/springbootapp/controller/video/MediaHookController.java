...
import cn.com.tzy.springbootapp.service.video.MediaHookService;
...
@RestController("AppVideoMediaServerController")
@RequestMapping(value = "/app"+ZLMediaKitConstant.HOOK_URL_PREFIX)
