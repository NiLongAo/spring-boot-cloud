...
import cn.com.tzy.springbootapp.service.video.DeviceChannelService;
...
@RestController("AppVideoDeviceChannelController")
@RequestMapping(value = "/app/video/device/channel")
