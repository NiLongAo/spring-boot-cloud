...
import cn.com.tzy.springbootapp.service.video.PlatformGbStreamService;
...
@RestController("AppVideoPlatformGbStreamController")
@RequestMapping(value = "/app/video/platform/gb_stream")
