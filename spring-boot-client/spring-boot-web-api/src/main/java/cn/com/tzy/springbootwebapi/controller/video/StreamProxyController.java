...
import cn.com.tzy.springbootwebapi.service.video.StreamProxyService;
...
@RestController("WebApiVideoStreamProxyController")
@RequestMapping(value = "/webapi/video/stream/proxy")
